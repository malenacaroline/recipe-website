        ...
        {sections.map((section, index) => (
          ...
          >
            ...
            <div className="about-content">
              ...
              <p className="about-content-info">{section.content}</p>
              {section.teamMembers && (
